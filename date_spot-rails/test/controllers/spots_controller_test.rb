...
class SpotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post spots_url, params: { spot: { avg_cost: @spot.avg_cost, description: @spot.description, location: @spot.location, title: @spot.title, url: @spot.url } }
    end
  ...
  test "should update spot" do
    patch spot_url(@spot), params: { spot: { avg_cost: @spot.avg_cost, description: @spot.description, location: @spot.location, title: @spot.title, url: @spot.url } }
